...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    FF_BUILD_NAME_AAC=fdk-aac-i386
    ...
    FF_BUILD_NAME_AAC=fdk-aac-x86_64
    FF_XCRUN_PLATFORM="iPhoneSimulator"
    ...
    FF_BUILD_NAME_AAC=fdk-aac-armv7
...
#    FFMPEG_CFG_CPU="--cpu=cortex-a8"
    ...
    FF_BUILD_NAME_AAC=fdk-aac-armv7s
    ...
    FF_BUILD_NAME_AAC=fdk-aac-arm64
